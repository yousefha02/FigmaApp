...
export default function Company()
{
    return(
        <div className="relative pt-[20px] overflow-hidden">
            ...
            <h2 className='text-center pl-4 text-[32px] leading-[34px] md:text-[48px] font-semibold text-btn md:leading-[60px] mb-5 lg:mb-20'>Get the best out of your company with our service</h2>
            <div>
