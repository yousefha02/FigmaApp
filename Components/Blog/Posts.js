...
export default function Posts()
{
    ...
    return(
        <div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 sm:gap-x-6 gap-y-20">
                {
                    infoposts.map((box,index)=>
                    {
                        return(
                            <div onClick={()=>router.push(`/blog/${box.id}`)} key={index+700} className="sm:w-[340px] sm:max-w-full cursor-pointer mx-auto">
                                <div>
