                ...
                <div>
                    {
                        info.map((box,index)=>
                            {
                                return(
                                    <div key={index+1800} className='flex flex-wrap items-center text-[16px] sm:text-[20px] mb-5'>
                                        <span className='bg-[#FFACAC] mr-3 text-btn max-w-full w-[44px] h-[44px] rounded-full flex items-center justify-center'><FontAwesomeIcon className='text-xl' icon={faArrowRight}/></span>
                                        {box}
                                    </div>
                                )
                            })
