...
export default function Post()
{
    ...
    return(on&&
        <div>
            ...
            <div className='grid sm:grid-cols-2 lg:grid-cols-3 xl:gird-cols-4 gap-x-6 gap-y-20'>
                {
                    load&&part.map((box,index)=>
                        {
                            return(
                                <div onClick={()=>router.push(`/blog/${box.id}`)} key={index+100} className="w-[380px] max-w-full cursor-pointer m-auto">
